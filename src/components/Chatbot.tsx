...
// ============================================================================
const GEMINI_KEY_PART_1: string = "AIzaSyAj3xKdV"; // <-- PASTE PART 1 HERE (e.g. "AIzaSyB...")
const GEMINI_KEY_PART_2: string = "DjNBXtKmw2Yb"; // <-- PASTE PART 2 HERE
const GEMINI_KEY_PART_3: string = "Zg6-Kb33KlTcs"; // <-- PASTE PART 3 HERE
