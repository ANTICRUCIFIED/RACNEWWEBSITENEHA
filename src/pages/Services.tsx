...
<h1 className="text-4xl md:text-6xl font-extrabold text-white mb-6">
      ...
      <section className="py-24 bg-gray-50 border-t border-b border-gray-100">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          <span className="text-brand-teal font-bold tracking-widest uppercase text-sm mb-4 block">Direct Advisor Access</span>
          <h2 className="text-3xl md:text-5xl font-extrabold text-brand-deep mb-4">
            Consultations & Voice Assistants
          </h2>
          <p className="text-gray-600 text-lg max-w-2xl mx-auto mb-16">
            Have questions about a specific regulatory pathway or service? Schedule a call, chat via WhatsApp, or talk to RAAAHI instantly.
          </p>
